...
class VideoIndexerClient:
    ...
    def authenticate_async(self, consts:Consts) -> None:
        ...
        self.vi_access_token, full_response = get_account_access_token_async(self.consts, self.arm_access_token)
        return self.arm_access_token, self.vi_access_token, full_response
